export default {
    ...
    showPost() {
        this.post.forEach((val, id)=> {
            ...
            <div class="col-md-6">
                <div class="row g-0 border rounded overflow-auto flex-md-row mb-4 shadow-sm h-md-250 position-relative" id="cards">
                <div class="col p-9 d-flex flex-column position-static">
                <h3 class="mb-0">${val.nombre}</h3><br>
                <p class="card-text mb-auto">${val.paragraph}</p>
                    <div class="imgPost">
                        <img src="${val.img}" class="img-fluid float-end">
                    </div>
